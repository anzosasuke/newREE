...
commandexe       = sgcc_base.mytest-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /scratch/wayedt/spec2017_root/tmp/CPU2017.071/templogs/preenv.intspeed.071.0
logname          = /scratch/wayedt/spec2017_root/tmp/CPU2017.071/templogs/preenv.intspeed.071.0
lognum           = 071.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on login1.ittc.ku.edu Fri Feb  4 01:22:23 2022
...
notes_plat_sysinfo_400 =     panfs://pfs.local:global panfs   50T   18T   32T  36% /panfs
...
review           = 0
run              = all
runcpu           = /scratch/wayedt/spec2017_root/bin/harness/runcpu --configfile my-gcc-linux-x86.cfg --fake --action build --noreportable --nopower --runmode speed --tune base --size refspeed 602.gcc_s --nopreenv --note-preenv --logfile /scratch/wayedt/spec2017_root/tmp/CPU2017.071/templogs/preenv.intspeed.071.0 --lognum 071.0 --from_runcpu 2
rundir           = run
runmode          = speed
safe_eval        = 1
save_build_files = 
