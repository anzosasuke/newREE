...
-r
-N C
-C /scratch/wayedt/spec2017_root/benchspec/CPU/602.gcc_s/run/run_base_train_mytest-m64.0000
-k -o 200.opts-O3_-finline-limit_50000.s.cmp /scratch/wayedt/spec2017_root/bin/specperl /scratch/wayedt/spec2017_root/bin/harness/specdiff -m -l 10 --floatcompare --nonansupport /scratch/wayedt/spec2017_root/benchspec/CPU/502.gcc_r/data/train/output/200.opts-O3_-finline-limit_50000.s 200.opts-O3_-finline-limit_50000.s > 200.opts-O3_-finline-limit_50000.s.cmp
-k -o scilab.opts-O3_-finline-limit_50000.s.cmp /scratch/wayedt/spec2017_root/bin/specperl /scratch/wayedt/spec2017_root/bin/harness/specdiff -m -l 10 --floatcompare --nonansupport /scratch/wayedt/spec2017_root/benchspec/CPU/502.gcc_r/data/train/output/scilab.opts-O3_-finline-limit_50000.s scilab.opts-O3_-finline-limit_50000.s > scilab.opts-O3_-finline-limit_50000.s.cmp
-k -o train01.opts-O3_-finline-limit_50000.s.cmp /scratch/wayedt/spec2017_root/bin/specperl /scratch/wayedt/spec2017_root/bin/harness/specdiff -m -l 10 --floatcompare --nonansupport /scratch/wayedt/spec2017_root/benchspec/CPU/502.gcc_r/data/train/output/train01.opts-O3_-finline-limit_50000.s train01.opts-O3_-finline-limit_50000.s > train01.opts-O3_-finline-limit_50000.s.cmp
