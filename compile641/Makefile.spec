...
commandexe       = leela_s_base.mytest-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /scratch/wayedt/spec2017_root/tmp/CPU2017.032/templogs/preenv.intspeed.032.0
logname          = /scratch/wayedt/spec2017_root/tmp/CPU2017.032/templogs/preenv.intspeed.032.0
lognum           = 032.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on login1.ittc.ku.edu Fri Nov 26 21:52:31 2021
...
path             = /scratch/wayedt/spec2017_root/benchspec/CPU/641.leela_s
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /scratch/wayedt/spec2017_root/bin/harness/runcpu --configfile my-gcc-linux-x86.cfg --fake --action build --noreportable --nopower --runmode speed --tune base --size refspeed 641.leela_s --nopreenv --note-preenv --logfile /scratch/wayedt/spec2017_root/tmp/CPU2017.032/templogs/preenv.intspeed.032.0 --lognum 032.0 --from_runcpu 2
rundir           = run
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /scratch/wayedt/spec2017_root/benchspec/CPU/541.leela_r/src
stagger          = 10
