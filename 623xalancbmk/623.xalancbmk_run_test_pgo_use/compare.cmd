...
-k -o test-test.out.cmp /scratch/wayedt/spec2017_root/bin/specperl /scratch/wayedt/spec2017_root/bin/harness/specdiff -m -l 10 /scratch/wayedt/spec2017_root/benchspec/CPU/523.xalancbmk_r/data/test/output/test-test.out test-test.out > test-test.out.cmp
